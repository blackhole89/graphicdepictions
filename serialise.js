 ...
 /* based on json2.js by Douglas Crockford, which was
...
// If the type is "function", hope that we have a representation of its source.
...
// and wrap them in braces.
    ...
    JSON.strong_stringify = function (value, replacer, space) {

// The strong_stringify method takes a value and an optional replacer, and an optional
// space parameter, and returns a JSON text. The replacer can be a function
// that can replace values, or an array of strings that will select the keys.
// A default replacer method can be provided. Use of the space parameter can
// produce text that is more easily readable.
// Unlike JSON.stringify, we (1) save the textual representation of functions, and
// (2) treat wrapped native classes in a special way.
